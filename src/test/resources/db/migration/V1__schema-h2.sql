...
, FOM DATE NOT NULL
, TOM DATE
, PERSON_LOPENR_R NUMBER(10, 0) NOT NULL
...
(
    VEDTAK_ID NUMBER(10, 0) NOT NULL
    , TIDSPUNKT_REG TIMESTAMP(6) -- NOT NULL
    , SAMORDNING CHAR(1 CHAR)
    , AKTIVITET CHAR(1 CHAR)
    , OVERGANG CHAR(1 CHAR)
    , KODE_OVERG VARCHAR2(6 CHAR)
    , BARNT_UTG NUMBER(5, 0)
    , UTDANNING NUMBER(5, 0)
    , TILSK_FLYTTING NUMBER(5, 0)
    , MANGL_ARBEID CHAR(1 CHAR)
    , MANGL_BTIL CHAR(1 CHAR)
    , STONAD_BELOP NUMBER(6, 0)
    , INNT_FRADRAG NUMBER(6, 0)
    , NETTO_BELOP NUMBER(6, 0)
    , BRUKERID VARCHAR2(8 CHAR) -- NOT NULL
    , ANT_MND NUMBER(2, 0)
    , SAM_FRADRAG NUMBER(6, 0)
    , OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp
    , OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp
...
(
    ...
    , KILDE_IS VARCHAR2(12 CHAR) DEFAULT ' ' NOT NULL
    , REGION CHAR(1 CHAR) DEFAULT ' ' NOT NULL
    , ID_PERS NUMBER -- GENERATED ALWAYS AS IDENTITY INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 200 NOT NULL
    , OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp
    --,     CONSTRAINT PK_SA_PERSON PRIMARY KEY (ID_PERS)
...
(
    ...
    , S05_GRUPPE VARCHAR2(2 CHAR) NOT NULL
    ...
    , KILDE_IS VARCHAR2(12 CHAR) DEFAULT ' ' NOT NULL
    , REGION CHAR(1 CHAR) DEFAULT ' ' NOT NULL
    , ID_SBLK NUMBER -- GENERATED ALWAYS AS IDENTITY INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 200 NOT NULL
    , OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp
    --,     CONSTRAINT PK_SA_SAKSBLOKK PRIMARY KEY (ID_SBLK)
    , DB_SPLITT CHAR(2 CHAR) DEFAULT '99'
);
...
(
    ...
    , S20_BREVNUMMER VARCHAR2(2 CHAR) NOT NULL
    , S20_MOTTAKERKODE VARCHAR2(3 CHAR) NOT NULL
    , S20_MOTTAKERNR VARCHAR2(11 CHAR) NOT NULL
    , S20_FNR_ANR_INSTNR NUMBER(11, 0) NOT NULL
    , S20_OPPLYSNING VARCHAR2(38 CHAR) NOT NULL
    , S20_ANT_PURREUKER_1 VARCHAR2(2 CHAR) NOT NULL
    , S20_ANT_PURREUKER_2 VARCHAR2(2 CHAR) NOT NULL
    , S20_ANT_PURREUKER_3 VARCHAR2(2 CHAR) NOT NULL
    , S20_S_PURRENR CHAR(1 CHAR) NOT NULL
    , S20_1_PURREDATO NUMBER(8, 0) NOT NULL
    , S20_2_PURREDATO NUMBER(8, 0) NOT NULL
    , S20_3_PURREDATO NUMBER(8, 0) NOT NULL
    , S20_RETURDATO NUMBER(8, 0) NOT NULL
    , S20_NESTE_PURREDATO NUMBER(8, 0) NOT NULL
    , S20_SAKSNR VARCHAR2(2 CHAR) NOT NULL
    ...
    , KILDE_IS VARCHAR2(12 CHAR) DEFAULT ' ' NOT NULL
    , REGION CHAR(1 CHAR) DEFAULT ' ' NOT NULL
    , ID_HEND NUMBER -- GENERATED ALWAYS AS IDENTITY INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 200 NOT NULL
    , OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp
    --,    CONSTRAINT PK_SA_HENDELSE PRIMARY KEY (ID_HEND)
...
(
    VEDTAK_ID NUMBER NOT NULL
    , TYPE_BELOP VARCHAR2(4 CHAR) NOT NULL
    , TIDSPUNKT_REG TIMESTAMP(6) NOT NULL DEFAULT current_timestamp
    , FOM DATE NOT NULL
    , TOM DATE
    , BELOP NUMBER(11, 2) NOT NULL
    , BRUKERID VARCHAR2(8 CHAR) NOT NULL
    ...
    , OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp
    , DB_SPLITT CHAR(2 CHAR) DEFAULT '  '
    --CONSTRAINT PK_BEREGN_GRL PRIMARY KEY (VEDTAK_ID, TYPE_BELOP, TIDSPUNKT_REG ) --IBERG01U
)